    ...
    return(
        <View style={styles.container}>
            ...
            <FlatList 
                ...
                style={styles.box}
            />
            <TouchableOpacity style={styles.btPesqReceita}>
                ...
                visible={true}>
                    <View style={styles.receita}>
                        <View style={styles.header}>
                            <Entypo name="arrow-long-left" size={24} style={styles.headerIcon} />
                            <Text>Receita</Text>
                        </View>
                        <Image source={require('../../../assets/img/logo.png')} style={{width: '100%'}}/>
                        <Text>Bacalhau com natas</Text>
                        <Text>Ingredientes</Text>
                        <Text>1. Bacallhau...</Text>
                        <Text>Modo Preparo</Text>
                        <Text>Modo de preparar é o seguinte....</Text>
                        <View>
                            <Text>Regional ou não</Text>
                        </View>
                        <View>
                            <Text>30min</Text>
                        </View>
                        <Text>Informações nutricionais</Text>
                        <Text>....</Text>
                        <View>
                            <Text>Diabetico</Text>
                        </View>
                        <Text>By Food Saver</Text>
                    </View>
            </Modal>
        </View>
    )
...
require('../../../assets/ingredientes/arroz.png')